...
![Deployment Flowchart]([Images/Deployment_Pipeline.png](https://github.com/LamAnnieV/Run_Jenkins_Build_and_Deploy_to_EB_Deployment02/blob/main/Images/Deployment_Pipeline.png))
